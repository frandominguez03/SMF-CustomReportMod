...
$txt['enable_large_report_field'] = 'Use bigger input field for writing reports';
$txt['enable_large_report_field_info'] = 'Instead of single line, it gives you are large text area while reporting posts';
$txt['post_report_board'] = 'Reported by';
$txt['post_link'] = 'Post Link';
$txt['report_solved'] = 'Mark Solved';
$txt['report_unsolved'] = 'Mark Unsolved';
$txt['report_board'] = 'Enable custom report mod.';
$txt['report_board_id'] = 'Board id to create post report.';
$txt['rtm_noboard'] = 'Admin forgot to create the report board.';

// Permission Strings
$txt['permissionname_can_solve_report'] = 'Can mark reports as solved';
$txt['permissionhelp_can_solve_report'] = 'This will allow user to mark the reports as solved.';
